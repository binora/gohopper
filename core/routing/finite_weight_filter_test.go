...
func (m *fwfFullMockEdgeIteratorState) SetWayGeometry(*util.PointList) util.EdgeIteratorState {
	return m
}
...
func (m *fwfFullMockEdgeIteratorState) SetBool(ev.BooleanEncodedValue, bool) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetReverseBool(ev.BooleanEncodedValue) bool { return false }
func (m *fwfFullMockEdgeIteratorState) SetReverseBool(ev.BooleanEncodedValue, bool) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) SetBoolBothDir(ev.BooleanEncodedValue, bool, bool) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetInt(ev.IntEncodedValue) int32 { return 0 }
func (m *fwfFullMockEdgeIteratorState) SetInt(ev.IntEncodedValue, int32) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetReverseInt(ev.IntEncodedValue) int32 { return 0 }
func (m *fwfFullMockEdgeIteratorState) SetReverseInt(ev.IntEncodedValue, int32) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) SetIntBothDir(ev.IntEncodedValue, int32, int32) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetDecimal(ev.DecimalEncodedValue) float64 { return 0 }
func (m *fwfFullMockEdgeIteratorState) SetDecimal(ev.DecimalEncodedValue, float64) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetReverseDecimal(ev.DecimalEncodedValue) float64 { return 0 }
func (m *fwfFullMockEdgeIteratorState) SetReverseDecimal(ev.DecimalEncodedValue, float64) util.EdgeIteratorState {
	return m
}
...
func (m *fwfFullMockEdgeIteratorState) SetString(*ev.StringEncodedValue, string) util.EdgeIteratorState {
	return m
}
func (m *fwfFullMockEdgeIteratorState) GetReverseString(*ev.StringEncodedValue) string { return "" }
func (m *fwfFullMockEdgeIteratorState) SetReverseString(*ev.StringEncodedValue, string) util.EdgeIteratorState {
	return m
}
...
func (m *fwfFullMockEdgeIteratorState) CopyPropertiesFrom(util.EdgeIteratorState) util.EdgeIteratorState {
	return m
}
